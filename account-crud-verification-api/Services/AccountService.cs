using account_crud_verification_api.Authorization;
using account_crud_verification_api.Entities;
using account_crud_verification_api.Helpers;
using account_crud_verification_api.Models.Accounts;
using AutoMapper;
...
namespace account_crud_verification_api.Services
{
    ...
    public class AccountService : IAccountService
    {
        ...
        #region Constructor
        public AccountService(DataContext context, IJwtUtils jwtUtils, IMapper mapper, IOptions<AppSettings> appSettings, IEmailService emailService)
        {
            _context = context;
            _jwtUtils = jwtUtils;
            _mapper = mapper;
        ...
        public AuthenticateResponse Authenticate(AuthenticateRequest model, string ipAddress)
        {
            ...
            // authentication succesfull so generate jwt and refresh token
        ...
        public void RevokeToken(string token, string ipAddress)
        {
            ...
            revokeRefreshToken(refreshToken, ipAddress, "Revoke without replacement");
            _context.Update(account);
            _context.SaveChanges();
        }
        ...
        private RefreshToken rotateRefreshToken(RefreshToken refreshToken, string ipAddress)
        {
            ...
            revokeRefreshToken(refreshToken, ipAddress, "Replace by a new token", newRefreshToken.Token);
